      ...
      <div>
         <Container className="overflow-hidden">
            <div className="relative mx-auto max-w-full pb-10 px-4 md:px-0">
               ...
               <div className={`flex flex-nowrap gap-8 mt-3 min-h-[450px] sm:min-h-[440px] ${position[active]} transition-transform duration-500`}>
                  <div>
            ...
            <div className="mx-auto max-w-5xl pb-32 px-10">
               <Tabs defaultValue="mug" value={active}>
                  ...
                  <TabsContent value="lemonade">
                     ...
                     <p className="text-lg dark:text-white">
                        The main was to make me people that they didn&lsquo;t have enough cover for there family if anything happened to them. The calculator was designed to be interactive so the user could see they need more cover. They then shown quotes from cover which they could select.
                     </p>

                     <div className="mt-10 flex flex-row gap-4">
                        {renderImages(works.lemonade.cover, 228, 456)}
                     </div>
                     ...
                     <div className="mt-10 grid grid-cols-1 md:grid-cols-2 gap-3">
                        {renderImages(works.lemonade.onePercentClub, 229, 458)}
                     </div>
                  </TabsContent>
                  ...
                  <TabsContent value="healthwatch">
                     ...
                     <div className="columns-2 gap-4">
                        {renderImages(works.healthwatch, 324, 456)}
                     </div>
                  </TabsContent>
               </Tabs>
            </div>
