      ...
      <Container>
         <div className="grid grid-cols-5 gap-6 mb-6 px-6 lg:px-0">
            ...
            <Card className="relative bg-primary col-span-full lg:col-span-2 min-h-52">
               ...
               <svg className="absolute -right-[5px] -top-[5px] z-0 opacity-100 dark:opacity-0" width="157" height="155" viewBox="0 0 157 155" fill="none" xmlns="http://www.w3.org/2000/svg">
               ...
               <svg className="absolute -right-[5px] -top-[5px] z-0 opacity-0 dark:opacity-100" width="157" height="155" viewBox="0 0 157 155" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path d="M0 1H4.77243C34.1812 1 57.9999 24.9568 57.9999 54.3415C57.9999 79.2064 78.1592 99.455 103 99.455C131.745 99.455 155.145 122.338 155.977 150.883L156 155H152V151H151.979C151.939 149.652 151.846 148.318 151.7 147C148.987 122.505 128.218 103.455 103 103.455C75.938 103.455 53.9999 81.4035 53.9999 54.3415C53.9999 28.2383 33.6831 6.77523 7.99994 5.10464C6.93301 5.03524 5.85681 5 4.77243 5H-6.10352e-05L0 1Z" fill="#262626" />
                  <path d="M157 0H-6.10352e-05L0 1H4.77243C34.1812 1 57.9999 24.9568 57.9999 54.3415C57.9999 79.2064 78.1592 99.455 103 99.455C131.745 99.455 155.145 122.338 155.977 150.883L156 155H157V0Z" fill="black" />
               </svg>
            ...
            <Card>
               ...
               <CardContent>
                  <div className="grid grid-cols-4 gap-6 lg:gap-12 justify-items-center lg:pt-10">
                     <Image className="dark:invert" src="./tools-icons/html.svg" alt="html icon" height={60} width={60} />
                     <Image className="dark:invert" src="../tools-icons/css.svg" alt="css icon" height={60} width={60} />
                     <Image className="dark:invert" src="../tools-icons/vue.svg" alt="vuejs icon" height={60} width={60} />
                     <Image className="dark:invert" src="../tools-icons/react.svg" alt="reactjs icon" height={60} width={60} />
                     <Image className="dark:invert" src="../tools-icons/figma.svg" alt="figma icon" height={60} width={60} />
                     <Image className="dark:invert" src="../tools-icons/ts.svg" alt="typescript icon" height={60} width={60} />
                     <Image className="dark:invert" src="../tools-icons/node.svg" alt="node icon" height={60} width={60} />
                     <Image className="dark:invert" src="./tools-icons/sass.svg" alt="sass icon" height={60} width={60} />
                  </div>
               </CardContent>
            </Card>
