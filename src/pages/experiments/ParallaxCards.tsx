         ...
         <div className="mx-auto max-w-5xl pb-10 px-10">
            ...
            <div className="relative">
               <div className="relative transition-transform will-change-transform mb-24"
                  ...
                  <img className="absolute z-0 left-0 top-0 origin-center" style={{ transform: 'translateZ(20px)' }} src="./experiments/parallax-cards/interstellar-6.png" />
                  <img className="absolute z-10 left-0 top-0 origin-center" style={{ transform: 'translateZ(70px)' }}
            ...
            <div className="relative transition-transform will-change-transform"
               ...
               <img src="./experiments/parallax-cards/oblivion-4.png" style={{
                  transform: 'translateZ(0px)'
               }} />
               <img className="absolute z-20 left-0 top-0 origin-center" style={{ transform: 'translateZ(30px)' }} src="./experiments/parallax-cards/oblivion-3.png" />
               <img className="absolute z-30 left-0 top-0 origin-center" style={{ transform: 'translateZ(80px)' }} src="./experiments/parallax-cards/oblivion-2.png" />
               <img className="absolute z-40 left-0 top-0 origin-center" style={{ transform: 'translateZ(120px)' }} src="./experiments/parallax-cards/oblivion-1.png" />
            </div>
         </div>
      </Container>
   )
